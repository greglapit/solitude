...
func assign_prop() -> void:
	...
	description = "-Special: Ravage\n-Cost: 2\n-Go on rampage, striking enemies for %d and ending with %d" % [swipe_dmg, final_swipe_dmg]
	display_texture = load("res://Common/UI/WeaponDisplay/Art/Weapons/5/5_claw_weapon.png")
