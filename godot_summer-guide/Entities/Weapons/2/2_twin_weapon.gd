...
func assign_prop() -> void:
	...
	description = "-Special: Mark\n-Attack and mark enemy for bonus %d damage on next attack\n-Cost: 1" % [damage_amt]
	display_texture = load("res://Common/UI/WeaponDisplay/Art/Weapons/2/2_twin_weapon.png")
...
func _process(_delta: float) -> void:
	if marked_enemy:
		weapon_effects2.position = marked_enemy.collision_shape.global_position
